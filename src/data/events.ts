...
// ⚠️ 브래킷 R1 이후(어퍼/로어 파이널·결승) 대진은 결과 의존 → 팀 TBD(미정).
  ...
  { id: "lck-w10-6", title: { en: "BRION vs DRX", ko: "브리온 vs DRX" }, category: "esports", sub: "lck", round: LCK_RISE, match: { home: LT.brion, away: LT.drx }, ...at("2026-07-31T10:00:00Z", "2026-07-31 19:00 Asia/Seoul"), description: { en: "Bo3 · 19:00 KST (Jul 31)", ko: "Bo3 · 한국 7/31 19:00 KST" }, emoji: "🎮" },
