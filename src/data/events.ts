...
export const EVENTS: CalEvent[] = [
  ...
  { id: "wc-qf4", title: { en: "Argentina vs Switzerland", ko: "아르헨티나 vs 스위스" }, category: "sports", sub: "worldcup", round: WC_QF, match: { home: { en: "Argentina", ko: "아르헨티나" }, away: { en: "Switzerland", ko: "스위스" } }, ...at("2026-07-12T01:00:00Z"), location: { en: "Arrowhead Stadium, Kansas City", ko: "애로우헤드 스타디움 (캔자스시티)" }, emoji: "⚽" },
...
// ⚠️ 브래킷 R1 이후(어퍼/로어 파이널·결승) 대진은 결과 의존 → 팀 TBD(미정).
  ...
  { id: "msi-lr3", title: { en: "G2 Esports vs LYON", ko: "G2 e스포츠 vs 리옹" }, category: "esports", sub: "msi", round: { en: "Lower R3", ko: "로어 브래킷 3라운드" }, match: { home: MT.g2, away: MT.lyon }, ...at("2026-07-10T08:00:00Z"), location: DJ, description: { en: "Lower Bracket R3 · 17:00 KST (Jul 10) · Bo5 · winner advances to Lower Final vs Hanwha Life Esports", ko: "로어 브래킷 3라운드 · 한국 7/10 17:00 KST · Bo5 · 승자 로어 파이널 한화생명전" }, emoji: "🎮" },
  { id: "msi-lower-final", title: { en: "MSI · Lower Final (TBD)", ko: "MSI · 로어 파이널 (미정)" }, category: "esports", sub: "msi", round: { en: "Lower Final", ko: "로어 파이널" }, match: { home: MT.hanwha, away: MT.tbd }, ...at("2026-07-11T08:00:00Z"), location: DJ, description: { en: "Lower Final · 17:00 KST (Jul 11) · Hanwha Life Esports vs winner of Lower R3 (G2 Esports/LYON)", ko: "로어 파이널 · 한국 7/11 17:00 KST · 한화생명e스포츠 vs 로어 3라운드 승자(G2/리옹)" }, emoji: "🎮" },
