...
export const EVENTS: CalEvent[] = [
  ...
  { id: "wc-sf1", title: { en: "France vs Spain", ko: "프랑스 vs 스페인" }, category: "sports", sub: "worldcup", round: WC_SF, match: { home: { en: "France", ko: "프랑스" }, away: { en: "Spain", ko: "스페인" } }, date: "2026-07-14", time: "20:00", location: { en: "AT&T Stadium, Dallas", ko: "AT&T 스타디움 (댈러스)" }, description: { en: "Result: France 0–2 Spain ✅ (Oyarzabal 22' pen, Porro 58') · Spain advance to Final vs England/Argentina winner", ko: "결과: 프랑스 0–2 스페인 ✅ (오야르사발 22' PK, 포로 58') · 스페인 결승 진출(잉글랜드/아르헨티나 승자와 대결)" }, emoji: "⚽" },
