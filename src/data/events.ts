...
export const EVENTS: CalEvent[] = [
  ...
  { id: "wc-final", title: { en: "World Cup Final", ko: "월드컵 결승" }, category: "sports", sub: "worldcup", round: WC_FINAL, starred: true, ...at("2026-07-19T19:00:00Z", "2026-07-19 15:00 America/New_York"), location: { en: "MetLife Stadium, NJ", ko: "메트라이프 스타디움 (뉴저지)" }, description: { en: "2026 FIFA World Cup Final · 3:00 PM ET", ko: "2026 FIFA 월드컵 결승 · 오후 3시 ET" }, emoji: "🏆" },
