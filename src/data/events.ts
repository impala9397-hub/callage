...
// ⚠️ 브래킷 R1 이후(어퍼/로어 파이널·결승) 대진은 결과 의존 → 팀 TBD(미정).
  ...
  { id: "ewc-grp-d2", title: { en: "EWC · Group Stage Day 2", ko: "EWC · 그룹 스테이지 2일차" }, category: "esports", sub: "ewc", round: EWC_GRP, ...at("2026-07-16T09:00:00Z", "2026-07-16 11:00 Europe/Paris"), location: PARIS_EXPO, description: { en: "Winners'/Elimination/Decider matches · from 11:00 CEST · matchups set by Day 1 results · top 2 per group advance", ko: "승자전·탈락전·최종전 · 파리 11:00 CEST부터 · 대진은 1일차 결과로 확정 · 조별 상위 2팀 플레이오프 진출" }, emoji: "🎮" },
  { id: "ewc-qf", title: { en: "EWC · Quarterfinals", ko: "EWC · 8강" }, category: "esports", sub: "ewc", round: { en: "Quarter-final", ko: "8강" }, ...at("2026-07-17T11:00:00Z", "2026-07-17 13:00 Europe/Paris"), location: PARIS_EXPO, description: { en: "Bo3 · from 13:00 CEST (Jul 17) · teams TBD (group stage results)", ko: "Bo3 · 파리 7/17 13:00 CEST부터 · 대진 미정(그룹 결과 대기)" }, emoji: "🎮" },
  { id: "ewc-sf", title: { en: "EWC · Semifinals", ko: "EWC · 준결승" }, category: "esports", sub: "ewc", round: { en: "Semi-final", ko: "준결승" }, ...at("2026-07-18T11:00:00Z", "2026-07-18 13:00 Europe/Paris"), location: PARIS_EXPO, description: { en: "Bo3 · from 13:00 CEST (Jul 18) · teams TBD", ko: "Bo3 · 파리 7/18 13:00 CEST부터 · 대진 미정" }, emoji: "🎮" },
  { id: "ewc-3rd", title: { en: "EWC · Third Place", ko: "EWC · 3위 결정전" }, category: "esports", sub: "ewc", round: { en: "Third Place", ko: "3위 결정전" }, ...at("2026-07-19T10:00:00Z", "2026-07-19 12:00 Europe/Paris"), location: PARIS_EXPO, description: { en: "Bo3 · 12:00 CEST (Jul 19) · teams TBD", ko: "Bo3 · 파리 7/19 12:00 CEST · 대진 미정" }, emoji: "🎮" },
  { id: "ewc-final", title: { en: "EWC Grand Final", ko: "EWC 그랜드 파이널" }, category: "esports", sub: "ewc", round: { en: "Final", ko: "결승" }, starred: true, ...at("2026-07-19T12:30:00Z", "2026-07-19 14:30 Europe/Paris"), location: PARIS_EXPO, description: { en: "Bo5 · 14:30 CEST (Jul 19) · teams TBD", ko: "Bo5 · 파리 7/19 14:30 CEST · 대진 미정" }, emoji: "🏆" },
